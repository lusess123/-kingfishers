    ...
    (function (QQEmotion) {
        ...
        var QQEmotionReact = (function (_super) {
            ...
            QQEmotionReact.prototype.pSender = function () {
                return React.createElement("div", {className: "Hu-content "}, React.createElement("div", {className: "clearfix"}, React.createElement("div", {id: "show", ref: "showqq"}), React.createElement("textarea", {ref: "saytext", id: "saytext", name: "saytext", className: " col-lg-12 col-md-12 col-sm-10 col-xs-10", placeholder: "说两句吧..."}), React.createElement("div", {className: "Hu-publish"}, React.createElement("span", {ref: "emotion"}, React.createElement("i", {className: "fa-lg fa fa-smile-o"})), React.createElement("a", {ref: "submit", className: "btn btn-xs"}, "发表"))));
            };
