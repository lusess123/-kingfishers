define(["require", "exports", "./../01core/Util"], function (require, exports, utilFile) {
    "use strict";
    var PicPreView = (function () {
        function PicPreView() {
        }
        PicPreView.GetRanNumber = function () {
            PicPreView.RanNumber++;
            return PicPreView.RanNumber;
        };
        PicPreView.showImageByDom = function (_$this, src) {
        ...
        PicPreView.RanNumber = 0;
        return PicPreView;
    }());
    exports.PicPreView = PicPreView;
});
