...
define(["require", "exports", "./../../../core/mcrv/AkBaseRenderer"], function (require, exports, baseRerFile) {
    "use strict";
    var WinInvoicingSellRer = (function (_super) {
        __extends(WinInvoicingSellRer, _super);
        function WinInvoicingSellRer() {
        ...
        WinInvoicingSellRer.prototype.init = function () {
            this["Title"] = "销售出库单";
            this["MasterTableName"] = "PSS_SellHead";
            this["$TopButtons"] = null;
            this["$BottomButtons"] = null;
        };
        return WinInvoicingSellRer;
    }(baseRerFile.AkBaseRenderer));
    exports.WinInvoicingSellRer = WinInvoicingSellRer;
    $.AKjs = $.AKjs ? $.AKjs : {};
