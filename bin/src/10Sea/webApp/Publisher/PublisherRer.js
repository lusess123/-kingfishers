...
define(["require", "exports", "./../../core/mcrv/AkBaseRenderer", "./../../../01core/Util"], function (require, exports, baseRerFile, utilFile) {
    "use strict";
    var PublisherRer = (function (_super) {
        __extends(PublisherRer, _super);
        function PublisherRer() {
        ...
        PublisherRer.prototype.getCer = function () {
            return utilFile.Core.Util.Cast(this.getCer());
        };
        PublisherRer.prototype.init = function (mylogo, res) {
            var _this = this;
            this.Data = res;
        ...
        ;
        PublisherRer.prototype.initAll = function () {
            var _this = this;
            this.$All.html("");
        ...
        PublisherRer.prototype.initActive = function () {
            var _this = this;
            this.$Active.html("");
            //文字发布框
        ...
        //生成按钮组方法
        PublisherRer.prototype.createBusiness = function ($contain) {
            var _this = this;
            var _root = this.Data.Roots;
            var item, $btngroup, href, regname, $li, $a, businessItem, $child;
        ...
        ;
        PublisherRer.prototype.createBusinessItem = function (item) {
            var _this = this;
            var $a;
        ...
        ;
        //按钮方法
        PublisherRer.prototype.clickPublisher = function (regName) {
        ...
        ;
        PublisherRer.prototype.canceltip = function () {
            var _this = this;
        ...
        ;
        PublisherRer.prototype.All = function () {
            this.canceltip();
        };
        ;
        PublisherRer.prototype.publishComplete = function () {
            var _this = this;
            return function (res) {
                if (res.res > 0) {
        ...
        ;
        PublisherRer.prototype.showTextEdit = function () {
        ...
        ;
        PublisherRer.prototype.showImage = function () {
        ...
        ;
        PublisherRer.prototype.showFile = function () {
            this.$Active.find(".ACT-IMAGE").css("display", "none");
        ...
        ;
        PublisherRer.prototype.cancleText = function () {
            var _this = this;
            var _$text = _this.$Active.find("textarea");
        ...
        PublisherRer.prototype.clearupload = function () {
    ...
    exports.PublisherRer = PublisherRer;
});
