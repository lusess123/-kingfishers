...
define(["require", "exports", "./../../core/mcrv/AkBaseModel"], function (require, exports, baseMerFile) {
    "use strict";
    var DocumentCenterMer = (function (_super) {
        __extends(DocumentCenterMer, _super);
        function DocumentCenterMer() {
            _super.apply(this, arguments);
            this.AkName = "DocumentCenterMer";
        }
        DocumentCenterMer.prototype.formartPageState = function (pagestyle, param) {
            var pageState = {};
            pageState.ds = {};
            if (pagestyle && param) {
        ...
        return DocumentCenterMer;
    }(baseMerFile.AkBaseModel));
    exports.DocumentCenterMer = DocumentCenterMer;
});
