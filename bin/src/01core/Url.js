define(["require", "exports", "./Util"], function (require, exports, urlFile) {
    "use strict";
    ...
    (function (Core) {
        $(function () {
            Util.AsyncJs([
                "/AtawStatic/lib/03Extend/bbq/jquery.ba-hashchange.min.js"], function () {
        ...
        })(Core.JsActionType || (Core.JsActionType = {}));
        var JsActionType = Core.JsActionType;
        Core.ActionCommond = {
            Alert: function (res) {
        ...
        function AkPost(url, data, callback, settings, $div) {
            // return null;
            // Util.Noty("请求");
