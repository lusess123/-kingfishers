        ...
        var MenuOrgPageVm = (function (_super) {
            ...
            MenuOrgPageVm.prototype.addMenu = function (name, types, rightValue) {
                ...
                if (types == "Menu") {
                    ...
                    urlFile.Core.AkPost("/RightCloud/NewRightConfig/getFid", {}, function (data) {
                        if (data) {
                            var newbtn = { FID: data, ButtonName: name, Org: "", ParentId: _this.MenuEditData.FID, ActionType: "Add", IMenuButton: null, RightValue: rightValue };
                            _this.MenuEditData.ButtonList.unshift(newbtn);
                            _this.MenuEditData = null;
                            //this.fun_isSame();
                            _this.ischange();
                            _this.forceUpdate("");
            ...
            MenuOrgPageVm.prototype.fun_Save = function () {
                ...
                //debugger
                //alert(menu);
                urlFile.Core.AkPost("/RightCloud/NewRightConfig/MenuOrgSubmit", { data: menu }, function (data) {
                    if (data) {
                        //刷新  
                        if (data) {
                            // urlFile.Core.AkUrl.Current().openUrl("$NEWRIGHTMAINPAGE$", true);
                            _this.emitAppEvent("NewMainDom/MenuOrgPage", _this.UniId, data);
                        }
                    }
                });
            };
