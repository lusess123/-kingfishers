    ...
    (function (Right) {
        ...
        var GroupNewPageReact = (function (_super) {
            ...
            GroupNewPageReact.prototype.pSender = function () {
                var _this = this;
                return React.createElement("div", {className: "acs-modals-panel"}, React.createElement("h4", null, "新增组织机构"), React.createElement("div", null, this.props.Vm.GroupRowList.map(function (l) {
                    return l.intoDom();
