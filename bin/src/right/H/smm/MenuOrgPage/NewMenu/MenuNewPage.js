    ...
    (function (MenuNewPage) {
        ...
        var MenuNewPageReact = (function (_super) {
            ...
            MenuNewPageReact.prototype.pSender = function () {
                var _this = this;
                return React.createElement("div", null, React.createElement("h4", null, "新增"), this.props.Vm.MenuRowObj.intoDom(), React.createElement("div", {className: "acsTextC acsMarginT3"}, React.createElement("a", {className: "button", onClick: function () { _this.fun_submitBtn(); }}, "提交")));
            };
        ...
        var MenuNewPageVm = (function (_super) {
            ...
            MenuNewPageVm.prototype.submit = function () {
                ...
                if (isSuccess) {
                    ...
                    this.SendPageActor({ ToPanelName: "", ToModuleName: "smmTestPage" }, { MenuName: this.Name, Type: this.type });
                    this.closePage();
                }
            };
        ...
        iocFile.Core.Ioc.Current().RegisterType("SmmMENUNEWPAGE", basewedPageFile.Web.BaseWebPageVm, MenuNewPageVm);
