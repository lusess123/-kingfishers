    ...
    (function (GroupSavePage) {
        ...
        var GroupSavePageReact = (function (_super) {
            ...
            GroupSavePageReact.prototype.fun_submit = function () {
                alert("dd");
                urlFile.Core.AkPost("/RightCloud/RightConfig/GroupSubmit", { GroupName: "", GroupKey: "" }, function (data) {
                });
            };
        ...
        var GroupSavePageVm = (function (_super) {
            ...
            function GroupSavePageVm() {
                ...
                this.OrgCodeESObj.ChangeEvent = function (vm, ischange) { alert(vm.Content); };
                this.OrgCodeESObj.ChangeEvent = function (vm, ischage) { alert(vm.Content); };
            }
