...
define(["require", "exports", "./../../../01core/0Dom", "react", "./MenuOrgTable"], function (require, exports, domFile, React, MenuOrgTableFile) {
    ...
    (function (MenuOrg) {
        ...
        var MenuOrgReact = (function (_super) {
            ...
            MenuOrgReact.prototype.test = function () {
                alert(this.props.Vm.table.IsMulit);
                console.log(this.props.Vm.table);
                return null;
            };
            MenuOrgReact.prototype.pSender = function () {
                return React.createElement("div", {className: "table-responsive"}, React.createElement("table", {className: "table table-hover table-bordered table-striped Hm-table-tree"}, this.props.Vm.table.rMenuOrgHeadSender(), this.props.Vm.table.rMenuOrgSender()));
            };
