    ...
    (function (Right) {
        ...
        var GroupNewMasterReact = (function (_super) {
            ...
            GroupNewMasterReact.prototype.pSender = function () {
                var _this = this;
                return (React.createElement("div", {className: "1"}, React.createElement("div", {className: "tabs-content"}, React.createElement("div", {className: "acs-form clearfix"}, React.createElement("div", {className: "large-6 small-12 columns"}, React.createElement("div", {className: "pull-left Hu-label"}, React.createElement("label", {className: "right required"}, "上级机构：")), React.createElement("div", {className: "pull-left Hu-input"}, this.props.Vm.ParentSelector.intoDom())), React.createElement("div", {className: "large-6 small-12 columns"}, React.createElement("div", {className: "pull-left Hu-label"}, React.createElement("label", {className: "right required"}, "机构名称：")), React.createElement("div", {className: "pull-left Hu-input"}, this.inputGroupName())), React.createElement("div", {className: "large-6 small-12 columns"}, React.createElement("div", {className: "pull-left Hu-label"}, React.createElement("label", {className: "right required"}, "机构编码：")), React.createElement("div", {className: "pull-left Hu-input"}, this.inputGroupCode())), React.createElement("div", {className: "large-12 small-12 columns"}, React.createElement("div", {className: "pull-left Hu-label"}, React.createElement("label", {className: "right"}, "机构描述：")), React.createElement("div", {className: "pull-left Hu-input"}, React.createElement("textarea", {value: this.props.Vm.GroupData.GroupDescrible, onChange: function (e) { _this.fun_OnChange(e, "GroupDescrible"); }}))), React.createElement("div", {className: "large-6 small-12 columns"}, React.createElement("div", {className: "pull-left Hu-label"}, React.createElement("label", {className: "right"}, "地址：")), React.createElement("div", {className: "pull-left Hu-input"}, React.createElement("input", {placeholder: "..", type: "text", value: this.props.Vm.GroupData.FAddress, onChange: function (e) { _this.fun_OnChange(e, "FAddress"); }}))), React.createElement("div", {className: "large-6 small-12 columns"}, React.createElement("div", {className: "pull-left Hu-label"}, React.createElement("label", {className: "right"}, "联系方式：")), React.createElement("div", {className: "pull-left Hu-input"}, React.createElement("input", {placeholder: "..", type: "text", value: this.props.Vm.GroupData.FPhone, onChange: function (e) { _this.fun_OnChange(e, "FPhone"); }}))), React.createElement("div", {className: "large-6 small-12 columns"}, React.createElement("div", {className: "pull-left Hu-label"}, React.createElement("label", {className: "right"}, "传真：")), React.createElement("div", {className: "pull-left Hu-input"}, React.createElement("input", {placeholder: "..", type: "text", value: this.props.Vm.GroupData.Fax, onChange: function (e) { _this.fun_OnChange(e, "Fax"); }}))), React.createElement("div", {className: "large-6 small-12 columns"}, React.createElement("div", {className: "pull-left Hu-label"}, React.createElement("label", {className: "right"}, "邮政编码：")), React.createElement("div", {className: "pull-left Hu-input"}, React.createElement("input", {placeholder: "..", type: "text", value: this.props.Vm.GroupData.Post, onChange: function (e) { _this.fun_OnChange(e, "Post"); }})))))));
            };
