    ...
    (function (EditMoneyRow) {
        ...
        var EditMoneyRowReact = (function (_super) {
            ...
            EditMoneyRowReact.prototype.pSender = function () {
                return React.createElement("tr", null, React.createElement("td", null, this.props.Vm.SalaryItemValue.SalaryItemID.Name), React.createElement("td", null, this.props.Vm.SalaryItemValue.Value));
            };
