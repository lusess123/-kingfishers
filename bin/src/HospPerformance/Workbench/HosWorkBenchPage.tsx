        ...
        public selectMenu(val: string)
        {
            ...
            switch (val)
            {
                ...
                case "科教管理系统":
                    ...
                    break;
                case "人事管理系统":
                    str = <a Vm={new alinkFile.ui.ALinkVm(true) }children={null}  href='x#$$module/HospPerformance/HumanResource/MRP_Department'><img src='../lib/akCss/icons/yuShuHos/jx_reshi.png' /><span>人事管理</span></a>;
                    break;
                case "总务管理系统":
                    ...
                    break;
                case "在线办公":
                    str = <a  Vm={new alinkFile.ui.ALinkVm(true) } children={null}  href='x#$$module/ExtraWork/extraWork'><img src='../lib/akCss/icons/yuShuHos/jx_zaixianbg.png' /><span>在线办公</span></a>;
                    break;
                case "院长管理系统":
                    str = <a  Vm={new alinkFile.ui.ALinkVm(true) } children={null}  href='x#$$module/HospPerformance/Director/performance_director_Appraisal_DeptResult'><img src='../lib/akCss/icons/yuShuHos/jx_bumen.png' /><span>院长管理系统</span></a>;
                    break;
                case "部门管理系统":
                    str = <a  Vm={new alinkFile.ui.ALinkVm(true) } children={null}  href='x#$$module/HospPerformance/Department/performance_department_Appraisal_DeptResult'><img src='../lib/akCss/icons/yuShuHos/jx_yuanzhang.png' /><span>部门管理系统</span></a>;
                    break;
            ...
            switch (val) {
                ...
                case "人事管理系统":
                    if (flag) {
                        str = <ul className="nav-item">
                            <li>人事管理</li>
                            <li><a  Vm={new alinkFile.ui.ALinkVm(true) } href="x#$$module/HospPerformance/HumanResource/MRP_Department" children={null}> 部门管理</a></li>
                            <li><a  Vm={new alinkFile.ui.ALinkVm(true) } href="x#$$module/HospPerformance/HumanResource/Ataw_UsersDetail" children={null}> 人员管理</a></li>
                            <li><a  Vm={new alinkFile.ui.ALinkVm(true) } href="x#$$module/HospPerformance/HumanResource/performance_hr_Salary_Item" children={null}> 薪资项目</a></li>
                        ...
                        str = <ul className="nav">
                            <li>人事管理</li>
                            <li className="nav-item"><a Vm={new alinkFile.ui.ALinkVm(true) } href="x#$$module/HospPerformance/HumanResource/MRP_Department" children={null}> 部门管理</a></li>
                            <li className="nav-item"><a Vm={new alinkFile.ui.ALinkVm(true) } href="x#$$module/HospPerformance/HumanResource/Ataw_UsersDetail" children={null}> 人员管理</a></li>                            
                            <li className="nav-item"><a Vm={new alinkFile.ui.ALinkVm(true) } href="x#$$module/HospPerformance/HumanResource/performance_hr_Salary_Item" children={null}> 薪资项目</a></li>                            
                ...
                case "在线办公":
                    if (flag) {
                        ...
                        str = <ul className="nav">
                            ...
                            <li className="nav-item"><a  Vm={new alinkFile.ui.ALinkVm(true) } href="x#$$module/ExtraWork/adminExtraWork" children={null}> 日常事务管理</a></li>
                        </ul>
                    }
                    break;
                case "院长管理系统":
                    if (flag) {
                        str = <ul className="nav-item">
                            <li>院长管理系统</li>
                            <li><a  Vm={new alinkFile.ui.ALinkVm(true) } href="x#$$module/HospPerformance/Director/performance_director_Appraisal_DeptResult" children={null}> 部门考核统计</a></li>
                            <li><a  Vm={new alinkFile.ui.ALinkVm(true) } href="x#$$module/HospPerformance/Director/performance_director_Appraisal_UserResult" children={null}> 员工考核统计</a></li>
                        ...
                        str = <ul className="nav">
                            <li>院长管理系统</li>
                            <li className="nav-item"><a  Vm={new alinkFile.ui.ALinkVm(true) } href="x#$$module/HospPerformance/Director/performance_director_Appraisal_DeptResult"children={null}> 部门考核统计</a></li>
                            <li className="nav-item"><a  Vm={new alinkFile.ui.ALinkVm(true) } href="x#$$module/HospPerformance/Director/performance_director_Appraisal_UserResult" children={null}> 员工考核统计</a></li>
                        </ul>
                    }
                    break;
                case "部门管理系统":
                    if (flag) {
                        str = <ul className="nav-item">
                            <li>部门管理系统</li>
                            <li><a  Vm={new alinkFile.ui.ALinkVm(true) } href="x#$$module/HospPerformance/Department/performance_department_Appraisal_DeptResult" children={null}> 部门考核统计</a></li>
                            <li><a  Vm={new alinkFile.ui.ALinkVm(true) } href="x#$$module/HospPerformance/Department/performance_department_Appraisal_UserResult" children={null}> 员工考核统计</a></li>
                        ...
                        str = <ul className="nav">
                            <li>部门管理系统</li>
                            <li className="nav-item"><a  Vm={new alinkFile.ui.ALinkVm(true) } href="x#$$module/HospPerformance/Department/performance_department_Appraisal_DeptResult"children={null}> 部门考核统计</a></li>
                            <li className="nav-item"><a  Vm={new alinkFile.ui.ALinkVm(true) } href="x#$$module/HospPerformance/Department/performance_department_Appraisal_UserResult" children={null}> 员工考核统计</a></li>
                        </ul>
                    }
                    break;
