    ...
    (function (DeptConclusionRowDom) {
        ...
        var DeptConclusionRowDomReact = (function (_super) {
            ...
            DeptConclusionRowDomReact.prototype.pSender = function () {
                var _this = this;
                return React.createElement("tr", null, React.createElement("td", null, React.createElement("span", null, React.createElement("i", {className: " fa fa-circle-o", onClick: function () { _this.props.Vm.getCheck(); }}))), React.createElement("td", null, this.props.Vm.AdviceData.Name), React.createElement("td", null, this.props.Vm.AdviceData.Summary), React.createElement("td", null, this.props.Vm.AdviceData.Advice));
            };
        ...
        var DeptConclusionRowDomVm = (function (_super) {
            ...
            function DeptConclusionRowDomVm(config) {
                ...
                this.AdviceData = { FID: "", Name: "", Summary: "", Advice: "" };
                if (config) {
