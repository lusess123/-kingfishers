    ...
    (function (MedicalRowDom) {
        ...
        var MedicalRowDomReact = (function (_super) {
            ...
            MedicalRowDomReact.prototype.pSender = function () {
                var _this = this;
                return (React.createElement("tr", null, React.createElement("td", null, this.props.Vm.rowNumber + 1), React.createElement("td", null, this.props.Vm.RowData.Name), React.createElement("td", null, this.props.Vm.isedit ? null : React.createElement("a", {className: "text-danger", onClick: function () { _this.props.Vm.delOpt(_this.props.Vm.rowNumber); }}, "删除"))));
            };
