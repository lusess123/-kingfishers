...
define(["require", "exports", "./../../../../01core/Ioc", "react", "./../../../../01core/Url", "./../../../../04page/BaseWebPage", "./MemberSearchDow", "./MemberGridFromDow", "./../../../../05tool/Pagination", "./../../../../05tool/Button", "./../../../../01core/Event"], function (require, exports, iocFile, React, urlFile, basewedPageFile, searchFormFile, gridFormFile, pagination, buttonFile, eventFile) {
    "use strict";
    var MemberListPage;
    (function (MemberListPage) {
        var MemberListPageAction = (function (_super) {
            __extends(MemberListPageAction, _super);
            function MemberListPageAction() {
                _super.apply(this, arguments);
            }
            return MemberListPageAction;
        }(basewedPageFile.Web.BaseWebPageStates));
        MemberListPage.MemberListPageAction = MemberListPageAction;
        var MemberListPageReact = (function (_super) {
            __extends(MemberListPageReact, _super);
            function MemberListPageReact() {
                _super.apply(this, arguments);
                this.state = new MemberListPageStates();
            }
            MemberListPageReact.prototype.pSender = function () {
            ...
            return MemberListPageReact;
        }(basewedPageFile.Web.BaseWebPageReact));
        MemberListPage.MemberListPageReact = MemberListPageReact;
        var MemberListPageVm = (function (_super) {
            __extends(MemberListPageVm, _super);
            function MemberListPageVm(config) {
                var _this = this;
                _super.call(this);
                this.ReactType = MemberListPageReact;
                ...
                this.listenAppEvent("loadMemberpagedata", this.UniId, function (pageIndex) {
                    _this.loadPageData(pageIndex);
                });
                this.listenAppEvent("medical/base/member/rowbtnclick", this.UniId, function (btnName, fid) {
                    _this[btnName + "Opt"](fid);
                });
            }
            MemberListPageVm.prototype.insertOpt = function () {
                urlFile.Core.AkUrl.Current().openUrl("$panelMemberinsertpage$", true);
            };
            MemberListPageVm.prototype.viewOpt = function (vals) {
                urlFile.Core.AkUrl.Current().openUrl("$panelMemberdetailpage$" + vals + "$", true);
            };
            MemberListPageVm.prototype.updateOpt = function (vals) {
                urlFile.Core.AkUrl.Current().openUrl("$panelMemberUPDATEPAGE$" + vals + "$", true);
            };
            MemberListPageVm.prototype.delOpt = function (vals) {
                var _this = this;
                if (confirm("你确定要删除 所选中的数据吗 ？？")) {
                    urlFile.Core.AkPost("/MedicalCenter/Member/RemoveMembers", { fids: vals }, function (data) {
            ...
            MemberListPageVm.prototype.getSelectValues = function () {
                var _list = [];
            ...
            MemberListPageVm.prototype.initButtons = function () {
            ...
            MemberListPageVm.prototype.createButton = function (displayName) {
                var _this = this;
            ...
            MemberListPageVm.prototype.buttonClickCommond = function (obj) {
            ...
            MemberListPageVm.prototype.init = function (config) {
                var _this = this;
                var searchConfig = { UniId: this.UniId };
                this.SearchFormVm = new searchFormFile.MemberSearchDow.MemberSearchDowVm(searchConfig);
            ...
            MemberListPageVm.prototype.loadPage = function (callback) {
                var _this = this;
                urlFile.Core.AkPost("/MedicalCenter/Member/SearchMembers", {}, function (a) {
            ...
            MemberListPageVm.prototype.checkCheckBox = function (val, checkDom) {
            ...
            MemberListPageVm.prototype.allCheckChecked = function (val, checkDom) {
                if (!window["isHand"]) {
            ...
            MemberListPageVm.prototype.loadPageData = function (pageIndex) {
                var _this = this;
            ...
            return MemberListPageVm;
        }(basewedPageFile.Web.BaseWebPageVm));
        MemberListPage.MemberListPageVm = MemberListPageVm;
        var MemberListPageStates = (function (_super) {
            __extends(MemberListPageStates, _super);
            function MemberListPageStates() {
                _super.apply(this, arguments);
            }
            return MemberListPageStates;
        }(basewedPageFile.Web.BaseWebPageStates));
        MemberListPage.MemberListPageStates = MemberListPageStates;
        var MemberListPageProps = (function (_super) {
            __extends(MemberListPageProps, _super);
            function MemberListPageProps() {
                _super.apply(this, arguments);
            }
            return MemberListPageProps;
        }(basewedPageFile.Web.BaseWebPageProps));
        MemberListPage.MemberListPageProps = MemberListPageProps;
        iocFile.Core.Ioc.Current().RegisterType("MemberLISTPAGE", basewedPageFile.Web.BaseWebPageVm, MemberListPageVm);
    })(MemberListPage = exports.MemberListPage || (exports.MemberListPage = {}));
});
