...
define(["require", "exports", "react", "./../../../../01core/Ioc", "./../../../../01core/Url", "./../../../../04page/BaseWebPage", "./AnomalySearchFormDom", "./AnomalyGridFormDom", "./../../../../05tool/Pagination", "./../../../../05tool/Button", "./../../../../01core/Event"], function (require, exports, React, iocFile, urlFile, basewedPageFile, searchFormFile, gridFormFile, pagination, buttonFile, eventFile) {
    "use strict";
    var AnomalyListPage;
    (function (AnomalyListPage) {
        var AnomalyListPageAction = (function (_super) {
            __extends(AnomalyListPageAction, _super);
            function AnomalyListPageAction() {
                _super.apply(this, arguments);
            }
            return AnomalyListPageAction;
        }(basewedPageFile.Web.BaseWebPageStates));
        AnomalyListPage.AnomalyListPageAction = AnomalyListPageAction;
        var AnomalyListPageReact = (function (_super) {
            __extends(AnomalyListPageReact, _super);
            function AnomalyListPageReact() {
                _super.apply(this, arguments);
                this.state = new AnomalyListPageStates();
            }
            AnomalyListPageReact.prototype.pSender = function () {
            ...
            AnomalyListPageReact.prototype.createButtons = function () {
                var _this = this;
            ...
            return AnomalyListPageReact;
        }(basewedPageFile.Web.BaseWebPageReact));
        AnomalyListPage.AnomalyListPageReact = AnomalyListPageReact;
        var AnomalyListPageVm = (function (_super) {
            __extends(AnomalyListPageVm, _super);
            function AnomalyListPageVm(config) {
                var _this = this;
                _super.call(this);
                this.ReactType = AnomalyListPageReact;
            ...
            AnomalyListPageVm.prototype.initBtnList = function () {
                var _this = this;
            ...
            AnomalyListPageVm.prototype.buttonClickCommond = function (obj) {
            ...
            AnomalyListPageVm.prototype.getSelectValues = function () {
                var _list = [];
            ...
            AnomalyListPageVm.prototype.insertOpt = function (vals) {
                urlFile.Core.AkUrl.Current().openUrl("$panelAnomalyinsertpage$", true);
            };
            AnomalyListPageVm.prototype.viewOpt = function (vals) {
                urlFile.Core.AkUrl.Current().openUrl("$panelAnomalydetailpage$" + vals + "$", true);
            };
            AnomalyListPageVm.prototype.updateOpt = function (vals) {
                urlFile.Core.AkUrl.Current().openUrl("$panelAnomalyupdatepage$" + vals + "$", false);
            };
            AnomalyListPageVm.prototype.delOpt = function (vals) {
                var _this = this;
                if (confirm("你确定要删除 所选中的数据吗 ？？")) {
                    urlFile.Core.AkPost("/MedicalCenter/Anomaly/RemoveAnomalies", { fids: vals }, function (data) {
            ...
            AnomalyListPageVm.prototype.init = function (config) {
                var _this = this;
            ...
            AnomalyListPageVm.prototype.loadPage = function (callback) {
                var _this = this;
                urlFile.Core.AkPost("/MedicalCenter/Anomaly/SearchAnomalies", {}, function (a) {
            ...
            AnomalyListPageVm.prototype.checkCheckBox = function (val, checkDom) {
            ...
            AnomalyListPageVm.prototype.allCheckChecked = function (val, checkDom) {
                if (!window["isHand"]) {
                    this.GridFormVm.RowList.forEach(function (row) {
                        var chk = row.SingleCheckVm;
            ...
            AnomalyListPageVm.prototype.loadPageData = function (pageIndex) {
                var _this = this;
            ...
            return AnomalyListPageVm;
        }(basewedPageFile.Web.BaseWebPageVm));
        AnomalyListPage.AnomalyListPageVm = AnomalyListPageVm;
        var AnomalyListPageStates = (function (_super) {
            __extends(AnomalyListPageStates, _super);
            function AnomalyListPageStates() {
                _super.apply(this, arguments);
            }
            return AnomalyListPageStates;
        }(basewedPageFile.Web.BaseWebPageStates));
        AnomalyListPage.AnomalyListPageStates = AnomalyListPageStates;
        var AnomalyListPageProps = (function (_super) {
            __extends(AnomalyListPageProps, _super);
            function AnomalyListPageProps() {
                _super.apply(this, arguments);
            }
            return AnomalyListPageProps;
        }(basewedPageFile.Web.BaseWebPageProps));
        AnomalyListPage.AnomalyListPageProps = AnomalyListPageProps;
        iocFile.Core.Ioc.Current().RegisterType("ANOMALYLISTPAGE", basewedPageFile.Web.BaseWebPageVm, AnomalyListPageVm);
    })(AnomalyListPage = exports.AnomalyListPage || (exports.AnomalyListPage = {}));
});
