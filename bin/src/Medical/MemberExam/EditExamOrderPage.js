    ...
    (function (ExamOrderPage) {
        ...
        var ExamOrderPageReact = (function (_super) {
            ...
            ExamOrderPageReact.prototype.pSender = function () {
                ...
                return (React.createElement("div", null, insertForm, button, this.props.Vm.GridFormVm.intoDom(), bottom, React.createElement("div", {className: "Hf-overflow", style: { height: 1, width: 1 }}, this.props.Vm.PickDomObj.intoDom())));
            };
        ...
        var ExamOrderPageVm = (function (_super) {
            ...
            ExamOrderPageVm.prototype.Search = function (val) {
                var _this = this;
                urlFile.Core.AkPost("/MedicalCenter/Reservation/SearchReservationByNumber", { searchText: val }, function (data) {
                    var _data = data.Data;
                    if (_data) {
            ...
            ExamOrderPageVm.prototype.loadPage = function (callback) {
                var _this = this;
                urlFile.Core.AkPost("/MedicalCenter/Reservation/SearchReservationByNumber", { searchText: this.Param1 }, function (data) {
                    var _data = data.Data;
                    if (_data) {
                        var Iconfig = {
                            data: _data,
