...
export module MenuRoleTable {

    export class MenuRoleTableAction extends domCore.DomAction { }

    export interface ILeftStyle {
        left: number;
    }

    export class MenuRoleTableReact extends domCore.DomReact<MenuRoleTableProps, MenuRoleTableStates, MenuRoleTableAction> implements domCore.IReact {
        public state = new MenuRoleTableStates();
        public pSender(): React.ReactElement<any> {
            return <div>名称为: MenuRoleTable的组件</div>;
        }

        protected pComponentDidMount() { super.pComponentDidMount(); }
    }

    export interface IMenuRoleTableConfig {
        ...
        Menu_Group: NewMainDom.NewMainDom.GroupData;
        Unid?: string;
    }

    export class MenuRoleTableVm extends domCore.DomVm {
        public ReactType = MenuRoleTableReact;
        public MenuRoleName = "";
        public Unid = "";
        ...
        public constructor(config?: IMenuRoleTableConfig) {
            super();
            if (config) {
        ...
        public addButton(name: any) {

            urlFile.Core.AkPost("/RightCloud/NewRightConfig/getFid", {}, (data) => {
                if (data) {
                    var button = { FID: name.MenuValue, ParentId: this.MenuEditData.FID, ButtonName: name.MenuName, ActionType: "Add"};
                    this.MenuEditData.isLeaft = false;
                    this.MenuEditData.IsHidden = false;
                    this.MenuEditData.isParent = true;
        ...
        public deleteMenu(a: Data.Menu.IMenuSimpleData) {
            urlFile.Core.AkPost("/RightCloud/NewRightConfig/CheckHasChild", { MenuID: a.FID }, (b) => {
        ...
        public submit() {
            //将结果循环起来
            var submitData: Data.Menu.ISubmitData = { MenuRoleDataList: [], GroupData: { Data: { GroupID: "", GroupName: "" }, DataID: "" } };
           ...
           // this.cycleUserData(submitData);
            ...
            urlFile.Core.AkPost("/RightCloud/NewRightConfig/RoleMenuSubmit", { data: JSON.stringify(submitData) }, (data) => {
                if (data) {
                    //刷新  
                    if (data) {
                        ...
                        this.emitAppEvent("NewMainDom/MenuRolePage", this.Unid, data);
        ...
        public GroupData: NewMainDom.NewMainDom.GroupData;
    ...
    export class MenuRoleTableStates extends domCore.DomStates { }

    export class MenuRoleTableProps extends domCore.DomProps<MenuRoleTableVm> { }
}