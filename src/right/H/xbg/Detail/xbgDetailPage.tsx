...
export module xbgTestPage {
    export class xbgDetailPageAction extends baseWebPageFile.Web.BaseWebPageAction {
    }

    export class xbgDetailPageReact extends baseWebPageFile.Web.BaseWebPageReact<xbgDetailPageProps, xbgDetailPageStates, xbgDetailPageAction> implements domFile.Core.IReact {

        public state = new xbgDetailPageStates();
    ...
    export class xbgDetailPageVm extends baseWebPageFile.Web.BaseWebPageVm {
        public ReactType = xbgDetailPageReact;
    ...
    export class xbgDetailPageStates extends baseWebPageFile.Web.BaseWebPageStates {
    }
    export class xbgDetailPageProps extends baseWebPageFile.Web.BaseWebPageProps<xbgDetailPageVm>{
    }
