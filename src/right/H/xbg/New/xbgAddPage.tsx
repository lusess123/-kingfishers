...
export module xbgTestPage {
    export class xbgAddPageAction extends baseWebPageFile.Web.BaseWebPageAction {
    }

    export class xbgAddPageReact extends baseWebPageFile.Web.BaseWebPageReact<xbgAddPageProps, xbgAddPageStates, xbgAddPageAction> implements domFile.Core.IReact {

        public state = new xbgAddPageStates();
    ...
    export class xbgAddPageVm extends baseWebPageFile.Web.BaseWebPageVm {
        public ReactType = xbgAddPageReact;
    ...
    export class xbgAddPageStates extends baseWebPageFile.Web.BaseWebPageStates {
    }
    export class xbgAddPageProps extends baseWebPageFile.Web.BaseWebPageProps<xbgAddPageVm>{
    }
