...
export module NewRolePage {
    ...
    export class NewRolePageReact extends basewedPageFile.Web.BaseWebPageReact<NewRolePageProps, NewRolePageStates, NewRolePageAction> implements domCore.IReact {
    ...
    export class NewRolePageVm extends basewedPageFile.Web.BaseWebPageVm {
        public ReactType = NewRolePageReact;
