...
export module MenuNewPage {
    ...
    export class MenuNewPageVm extends basewedPageFile.Web.BaseWebPageVm {
        ...
        public submit() {
            ...
            if (true) {
                ...
                this.SendPageActor({ ToPanelName: "", ToModuleName: "RIGHTMAINPAGE" }, { MenuName: this.Name, Type: this.type, RightValue: menuInsert.NameData.RightValue });
                this.closePage();
            }
        }
    ...
    iocFile.Core.Ioc.Current().RegisterType("MENUNEWPAGE", basewedPageFile.Web.BaseWebPageVm, MenuNewPageVm);
