...
export module MainDom {
    ...
    export class MainDomReact extends domCore.DomReact<MainDomProps, MainDomStates, MainDomAction> implements domCore.IReact {
        ...
        public pSender(): React.ReactElement<MainDomProps> {
                    ...
                    <div className="Hm-grids">
                        ...
                        <div className="tab-content ">
                            ...
                            <div className={"tab-pane Hg-relative clearfix " + (this.props.Vm.TabCurrentIndex == 1 ? " active" : " ") }>
                                <div>
                                    <div className="">
                                        {this.props.Vm.UserMenuRoleObj ? this.props.Vm.UserMenuRoleObj.intoDom() : null}
    ...
    export class MainDomVm extends domCore.DomVm {
        ...
        public constructor(config?: IMainDomConfig) {
            ...
            this.listenAppEvent("MainDom/MenuOrgPage", config.UinId, (name: string) => {
                if (this.OrgName) {
                    this.RoleMenuLoadPage(this.OrgName);
                }
            });

            this.listenAppEvent("MainDom/MenuUSerRolePage", config.UinId, (name: string) => {
                if (!this.OrgName) {
        ...
        public GroupSave() {
            if (this.OrgNameESObj.Content != "" && this.OrgCodeESObj != "") {
                urlFile.Core.AkPost("/Rightcloud/RightConfig/GroupSubmit", { GroupName: this.OrgNameESObj.Content, GroupKey: this.OrgCodeESObj }, (a) => {
                    if (a != null)
                        alert(a);
                    else
                        alert("返回值为空");
        ...
        public MenuUserRoleLoadPage(Group: string, pageIndex: number) {
            ...
            urlFile.Core.AkPost("/Rightcloud/RightConfig/secodeinit", { Groups: Group, pager: JSON.stringify(_page) }, (a) => {
                if (a) {
                    ...
                    this.UserMenuRoleObj.table.IsChange = true;
                    this.UserMenuRoleObj.table.IsMulit = true;
                    this.forceUpdate("");
                }
            });
        }
    ...
    export class MainDomProps extends domCore.DomProps<MainDomVm> { }
}