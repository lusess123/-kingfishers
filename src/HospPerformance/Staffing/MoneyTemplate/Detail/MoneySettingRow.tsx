        ...
        public constructor(config?: IMoneySettingRowConfig) {
            ...
            var modal: modalFile.ModalDom.IModalDomConfig = {
                ...
                ModalShowingFun: (a, callback) => {
                    var _config: EditMoneySettingPageFile.EditMoneySettingPage.IEditMoneySettingPageConfig = { DataValue: this.SalaryItemValue, Unid: this.UniId, UserId: a.UniId, UserName:"" }
                    if (this.SalaryItemSetData.UserID == a.UniId) {
                        _config.DataValue = this.SalaryItemSetData.SalaryItemValue;                        
                    }
