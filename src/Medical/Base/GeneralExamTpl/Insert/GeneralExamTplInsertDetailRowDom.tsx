...
export module GeneralExamTplInsertDetailRowDom {
    export class GeneralExamTplInsertDetailRowDomAction extends domCore.DomAction {
    }

    export class GeneralExamTplInsertDetailRowDomReact extends domCore.DomReact<GeneralExamTplInsertDetailRowDomProps, GeneralExamTplInsertDetailRowDomStates, GeneralExamTplInsertDetailRowDomAction> implements domCore.IReact {

        public state = new GeneralExamTplInsertDetailRowDomStates();
    ...
    export interface IGeneralExamTplInsertDetailRowDomConfig {
        UniId: string;
    ...
    export class GeneralExamTplInsertDetailRowDomVm extends domCore.DomVm {
        public ReactType = GeneralExamTplInsertDetailRowDomReact;
        ...
        public constructor(config?: IGeneralExamTplInsertDetailRowDomConfig) {
            super();
            if (config) {
    ...
    export class GeneralExamTplInsertDetailRowDomStates extends domCore.DomStates {
    }


    export class GeneralExamTplInsertDetailRowDomProps extends domCore.DomProps<GeneralExamTplInsertDetailRowDomVm>{
    }
