...
import gridFormFile = require("./UserGridFormDom");

export module UserListPage {
    export class UserListPageAction extends basewedPageFile.Web.BaseWebPageAction {
        public DataValue: string;
        public Id: string;
        public Vm: any;
    }

    export class UserListPageReact extends basewedPageFile.Web.BaseWebPageReact<UserListPageProps, UserListPageStates, UserListPageAction> implements domCore.IReact {
        public state = new UserListPageStates();
    ...
    export interface UserListPageConfig {
        PagerListData: dataFile.User.UserPageListData;
    }

    export class UserListPageVm extends basewedPageFile.Web.BaseWebPageVm {
        public ReactType = UserListPageReact;

        public PaginationVm: pagination.tool.PaginationVm;
        public PagerListData: dataFile.User.UserPageListData;
        ...
        public GridFormVm: gridFormFile.UserGridFormDom.UserGridFormDomVm;

        public constructor(config?: UserListPageConfig) {
            super();
            this.UniId = eventFile.App.getUniId().toString();
            this.initButtons();
            this.listenAppEvent("loaduserspagedata", this.UniId, (pageIndex: number) => {
                this.loadPageData(pageIndex);
            });
            this.listenAppEvent("medical/base/users/rowbtnclick", this.UniId, (btnName: string, fid: string) => {
        ...
        public delOpt(vals: string) {
            if (confirm("你确定要删除 所选中的数据吗 ??")) {
                urlFile.Core.AkPost("/MedicalCenter/Users/RemoveUsers", { fids: vals }, (data) => {
        ...
        private getSelectValues() {
            var _list: dataFile.User.UserData[] = [];
        ...
        public init(config: UserListPageConfig) {
            ...
            this.PaginationVm.PageClickEvent = (pagerIndex) => {
                this.loadPageData(pagerIndex);
            }
        ...
        protected loadPage(callback?: () => any) {
            urlFile.Core.AkPost("/MedicalCenter/Users/SearchUsers", {}, (a) => {
                var pageConfig: UserListPageConfig = { PagerListData: a.Data };
    ...
    export class UserListPageStates extends basewedPageFile.Web.BaseWebPageStates { }

    export class UserListPageProps extends basewedPageFile.Web.BaseWebPageProps<UserListPageVm>{ }
