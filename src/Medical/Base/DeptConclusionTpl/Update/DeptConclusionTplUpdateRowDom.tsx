...
import masterRowFile = require("./DeptConclusionTplUpdateMasterRowDom");
//import detailRowFile = require("./DeptConclusionTplUpdateDetailRowDom");
import detailRowFile = require("./../../../Common/ItemConditionUpdateDetailRowDom");
import eventFile = require("./../../../../01core/Event");
import dataFile = require("./../Data");

export module DeptConclusionTplUpdateRowDom {
    export class DeptConclusionTplUpdateRowDomAction extends domCore.DomAction {
    }

    export class DeptConclusionTplUpdateRowDomReact extends domCore.DomReact<DeptConclusionTplUpdateRowDomProps, DeptConclusionTplUpdateRowDomStates, DeptConclusionTplUpdateRowDomAction> implements domCore.IReact {

        public state = new DeptConclusionTplUpdateRowDomStates();
    ...
    export interface IDeptConclusionTplUpdateRowDomConfig {
        //DetailRowConfigList: detailRowFile.DeptConclusionTplUpdateDetailRowDom.IDeptConclusionTplUpdateDetailRowDomConfig[];
        DetailRowConfigList: detailRowFile.ItemConditionUpdateDetailRowDom.IItemConditionUpdateDetailRowDomConfig[];
        MasterConfig: masterRowFile.DeptConclusionTplUpdateMasterRowDom.IDeptConclusionTplUpdateMasterRowDomConfig;

    }



    export class DeptConclusionTplUpdateRowDomVm extends domCore.DomVm {
        public ReactType = DeptConclusionTplUpdateRowDomReact;
        ...
        public MasterRow: masterRowFile.DeptConclusionTplUpdateMasterRowDom.DeptConclusionTplUpdateMasterRowDomVm = new masterRowFile.DeptConclusionTplUpdateMasterRowDom.DeptConclusionTplUpdateMasterRowDomVm();
        ...
        public constructor(config?: IDeptConclusionTplUpdateRowDomConfig) {
            super();
            ...
            this.listenAppEvent("medical/base/DeptConclusionTpl/update/DetailRow", this.UniId, (rowIndex: number) => {
        ...
        public getData(): dataFile.DeptConclusionTpl.IDeptConclusionTplData {
            var _list = [];
            this.DetailRowList.forEach((r) => {
                var _obj = r.getData();
    ...
    export class DeptConclusionTplUpdateRowDomStates extends domCore.DomStates {
    }


    export class DeptConclusionTplUpdateRowDomProps extends domCore.DomProps<DeptConclusionTplUpdateRowDomVm>{
    }
