...
import updateRowFile = require("./UnitUpdateRowDom");
import dataFile = require("./../Data");

export module UnitUpdatePage {
    export class UnitUpdatePageAction extends basewedPageFile.Web.BaseWebPageStates {
        public DataValue: string;
        public Id: string;
        public Vm: any;
    }

    export class UnitUpdatePageReact extends basewedPageFile.Web.BaseWebPageReact<UnitUpdatePageProps, UnitUpdatePageStates, UnitUpdatePageAction> implements domCore.IReact {

        public state = new UnitUpdatePageStates();
    ...
    export interface IUnitUpdatePageConfig {
        RowConfigList: updateRowFile.UnitUpdateRowDom.IUnitUpdateRowDomConfig[];
    }

    export class UnitUpdatePageVm extends basewedPageFile.Web.BaseWebPageVm {
        public ReactType = UnitUpdatePageReact;
        public RowList: updateRowFile.UnitUpdateRowDom.UnitUpdateRowDomVm[] = [];


        public constructor(config?: IUnitUpdatePageConfig) {
            super();
            this.Title = "编辑单位信息";
            if (config) {
                this.init(config);
        ...
        private init(config: IUnitUpdatePageConfig) {
        ...
        public submit() {
            if (this.legal()) {
                ...
                if (dt) {
                    ...
                    urlFile.Core.AkPost("/MedicalCenter/Unit/ModifyUnits", { units: str }, (a) => {
                        if (a.Content == "ok") {
    ...
    export class UnitUpdatePageStates extends basewedPageFile.Web.BaseWebPageStates {
    }


    export class UnitUpdatePageProps extends basewedPageFile.Web.BaseWebPageProps<UnitUpdatePageVm>{
    }
