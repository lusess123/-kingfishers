...
export module ExamOrderPage {
    ...
    export class ExamOrderPageVm extends basewedPageFile.Web.BaseWebPageVm {
        ...
        // public RowList = new Array<examOrderDomFile.ExamOrderGridRow.ExamOrderGridRowVm>();
        ...
        public Search(val: string) {
            if (val != "" && val != null) {
                ...
                urlFile.Core.AkPost("/MedicalCenter/Reservation/SearchMemberReservation", { searchText: val }, (data) => {
                    var _data = data.Data;
                    if (_data) {
