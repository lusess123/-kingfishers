...
export module AnomalySelectorDom {
    ...
    export interface IAnomalySelectorDomConfig {
        derpartData?: data.Result.PagerListData<data.Result.AnomalyTemplate>;
    ...
    export class AnomalySelectorDomVm extends domCore.DomVm implements IReactAnomalySelectorDomVm {
        ...
        public constructor(config?: IAnomalySelectorDomConfig) {
            ...
            this.listenAppEvent("medical/Departments/tools/AnomalyConclusion", this.UniId, (fid: string) => {
                urlFile.Core.AkPost("/MedicalCenter/AnomalyConclusion/GetExamItem",
                    {
                        ...
                        if (a.Data && a.Data.length > 0) {
                            a.Data.forEach((b) => {
                                var model: data.Result.ItemTemplate = { FID: b.FID, ItemName: b.ItemName, GreaterThan: b.GreaterThan, LessThan: b.LessThan, KeyWord: b.KeyWord, IsPositive: b.IsPositive }
                                list.push(model);
                            })
                        }
