...
export class ActivityRer extends baseRerFile.AkBaseRenderer {

    public AkName = "ActivityRer";
    public $Header = null;
    public $MyWork = null;
    public $NewMain = null;
    public $Main = null;
    ...
    public $SecondHeader = null;

    public getCer(): cFile.Activitycer {
        return utilFile.Core.Util.Cast<cFile.Activitycer>(this.C);
    }
    ...
    public routNewsComming() {
        ...
        if (type === "Activity" && type2 === "all") { this.getCer()["exeNewComming"](type2 + 'NewsComming'); }
        else {
    ...
    public routMore(type) {
        this.getCer()["exeMore"](type + 'More');
    }

    public setDefault(res) {
        if (res.Data) {
    ...
    public ActivityGroupByDate($JObj) {
    ...
    public setDefaultNewsComming(res) {
        var _dt = res.Data["SNS_ACTIVITIES"];
        if (_dt.length > 0) { $.AKjs.App.LatestActivityTime = _dt[0]["CREATE_TIME"]; }
        var _form = res.Forms["SNS_ACTIVITIES"];
        _form.HasPager = false;
        _form.FormType = "Activity";
        var _op = { Data: res.Data, Form: _form };
    ...
    public setAllNewsComming(res) {
        this.setDefaultNewsComming(res);
    };
    public setAllMore(res) {
        this.setDefaultMore(res);
    };
    //圈子
    public setCircleR(res) {
        var _this = this;
        this.setDefault(res);
        this["$More"]["find"]("a")["off"]("click")["on"]("click", function () {
    ...
    public setCircleNewsComming(res) {
        this.setDefaultNewsComming(res);
    };
    public setCircleMoreR(res) {
        this.setDefaultMore(res);
    }

    //未读
    public setUnreadR(res) {
        var _this = this;
        this.setDefault(res);
        this["$More"]["find"]("a")["off"]("click")["on"]("click", function () {
    ...
    public setUnreadNewsComming(res) {
        this.setDefaultNewsComming(res);
    };
    public setUnreadMoreR(res) {
        this.setDefaultMore(res);
    }


    //事务
    public setWorkflowR(res) {
        var _this = this;
        this.setDefault(res);
        this["$More"]["find"]("a")["off"]("click")["on"]("click", function () {
    ...
    public setWorkflowNewsComming(res) {
        this.setDefaultNewsComming(res);
    };
    public setWorkflowMoreR(res) {
        this.setDefaultMore(res);
    }
    //与我相关
    public setRelationMeR(res) {
        var _this = this;
        this.setDefault(res);
        this["$More"]["find"]("a")["off"]("click")["on"]("click", function () {
    ...
    public setRelationMeNewsComming(res) {
        this.setDefaultNewsComming(res);
    };
    public setRelationMeMoreR(res) {
        this.setDefaultMore(res);
    }
    //关注的人
    public setAttentionR(res) {
        var _this = this;
        this.setDefault(res);
        this["$More"]["find"]("a")["off"]("click")["on"]("click", function () {
    ...
    public setAttentionNewsComming(res) {
        this.setDefaultNewsComming(res);
    };
    public setAttentionMoreR(res) {
        this.setDefaultMore(res);
    }

    //我的工作
    public setTopMyWork(op) {
        this.clear();
    ...
    public setMyFavoriteNewsComming(res) {
        this.setDefaultNewsComming(res);
    };
    public setMyFavoriteMoreR(res) {
        this.setDefaultMore(res);
    }
