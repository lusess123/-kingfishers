...
export module bd_PayInfoPage {
    ...
    export class bd_PayInfoPageReact extends basewedPageFile.Web.BaseWebPageReact<bd_PayInfoPageProps, bd_PayInfoPageStates, bd_PayInfoPageAction> implements domCore.IReact {
        ...
        private clickImgFun(src: string,e:React.MouseEvent): void {
            ...
            utilFile.Core.Util.AsyncJs(["/AtawStatic/lib/03Extend/imgdiscuz/js/common.js", "/AtawStatic/lib/03Extend/imgdiscuz/js/common_extra.js",
                ...
                "/AtawStatic/lib/03Extend/imgdiscuz/img/style_1_forum_viewthread.css"], function () {
                    ...
                    window["aimgcount"] = [_imgId];
                    window["attachimggroup"](1000);
                    window["attachimgshow"](1000);
                    var aimgfid = 0;

                    window["zoom"](_$this[0], _$this.attr("src"), 0, 0, 0);
...
<<<<<<< .mine
                <td><a onClick={(e) => { this.clickImgFun(a.DraftImage,e); } }><img width='38' height='38'  src={a.DraftImage}></img></a></td>
                <td><img  width='38' height='38'  src={a.BankImgSplit}></img></td>
||||||| .r22382
                <td><img width='38' height='38'  src={a.DraftImage}></img></td>
                <td><img  width='38' height='38'  src={a.BankImgSplit}></img></td>
=======
                <td><img width='38' height='38'  src={a.DraftImage} onClick={() => { this.Fun_ImageShow(a.DraftImage) } }></img></td>
                <td><img  width='38' height='38'  src={a.BankImgSplit} onClick={() => { this.Fun_ImageShow(a.BankImgSplit) } }></img></td>
>>>>>>> .r22467
        ...
        protected pInstall(): void {
            ...
            this.props.Vm.getEmit("React").addListener("pageLoadEnd", () => {
                if ($.fn.AtawSelector) {
                    var _$dom1 = $(React.findDOMNode(this)).find(".ACT-TEST");
                    ...
                    //$(React.findDOMNode(this)).find(".ACT-TEST2")["AtawMultiSelector"]({ RegName: "BiDaDepartmentCodeTable" });

                    var _$dom2 = $(React.findDOMNode(this)).find(".ACT-TEST2");
        ...
        public Search() {
            var dd = {
                "bd_PayInfo_SEARCH": [
                    {
                        "FlowNumber_LIKE": this.props.Vm.Search_FlowNumber,
                        "ApplyUserId": this.props.Vm.Search_ApplyUserId,
                        "FBankType": this.props.Vm.Search_FBankType,
                        "FAcceptkind": this.props.Vm.Search_FAcceptkind,
                        "FDepartmentID": this.props.Vm.Search_FDepartmentID
                    }
                ],
                "PAGER": [
                    {
        ...
        public _initPagination() {
            ...
            this.props.Vm.Pagetion.PageClickEvent = (pageIndex) => {
                ...
                {
                    ds.push({ "FAcceptkind": this.props.Vm.Search_ApplyUserId })
                }
    ...
    export class bd_PayInfoPageVm extends basewedPageFile.Web.BaseWebPageVm {
        ...
        protected loadPage(callback?: Function) {
            ...
            urlFile.Core.AkPost("/module/module", { xml: "module/BiDa/business/bd_PayInfo", ds: "", pageStyle: "List" }, (a) => {
                ...
                //this.forceUpdate("", () => {
                //    this.getEmit("React").emit("pageLoadEnd");
                //    //$(React.findDOMNode(this)).find("ACT_TEST").
                //});
            })
