...
import searchFormFile = require("./ReportElectricalMaintanceSearchFormDom");
import gridFormFile = require("./ReportElectricalMaintanceGridFormDom");
...
export module ReportElectricalMaintanceListPage {
    export class ReportElectricalMaintanceListPageAction extends basewedPageFile.Web.BaseWebPageStates {
        public DataValue: string;
        public Id: string;
        public Vm: any;
    }

    export class ReportElectricalMaintanceListPageReact extends basewedPageFile.Web.BaseWebPageReact<ReportElectricalMaintanceListPageProps, ReportElectricalMaintanceListPageStates, ReportElectricalMaintanceListPageAction> implements domCore.IReact {

        public state = new ReportElectricalMaintanceListPageStates();
    ...
    export interface IReportElectricalMaintanceListPageConfig {
        //PagerListData: dataFile.ReportElectricalMaintance.IReportElectricalMaintancePagerListData;
        DataSet?: any;
    }

    export class ReportElectricalMaintanceListPageVm extends basewedPageFile.Web.BaseWebPageVm {
        public ReactType = ReportElectricalMaintanceListPageReact;
        public SearchFormVm: searchFormFile.ReportElectricalMaintanceSearchFormDom.ReportElectricalMaintanceSearchFormDomVm;
        public GridFormVm: gridFormFile.ReportElectricalMaintanceGridFormDom.ReportElectricalMaintanceGridFormDomVm;
        ...
        public constructor(config?: IReportElectricalMaintanceListPageConfig) {
            super();
        ...
        private init(config: IReportElectricalMaintanceListPageConfig) {
        ...
        protected loadPage(callback?: () => any) {
            urlFile.Core.AkPost("/HZTongBao/Report/ElectricalMaintance", {  }, (a) => {
                var pageConfig: IReportElectricalMaintanceListPageConfig = { DataSet: a};
    ...
    export class ReportElectricalMaintanceListPageStates extends basewedPageFile.Web.BaseWebPageStates {
    }


    export class ReportElectricalMaintanceListPageProps extends basewedPageFile.Web.BaseWebPageProps<ReportElectricalMaintanceListPageVm>{
    }
