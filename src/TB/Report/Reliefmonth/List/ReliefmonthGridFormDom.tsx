...
import gridRowFile = require("./ReliefmonthGridRowDom");
import singleCheckFile = require("./../../../../02col/02Mulite/SingleCheckBox");
import dataFile = require("./../Data");

export module ReliefmonthGridFormDom {
    export class ReliefmonthGridFormDomAction extends domCore.DomAction {
    }

    export class ReliefmonthGridFormDomReact extends domCore.DomReact<ReliefmonthGridFormDomProps, ReliefmonthGridFormDomStates, ReliefmonthGridFormDomAction> implements domCore.IReact {

        public state = new ReliefmonthGridFormDomStates();
    ...
    export interface IReliefmonthGridFormDomConfig {
        DataSet?: any
        UniId: string;
    }

    export class ReliefmonthGridFormDomVm extends domCore.DomVm {
        public ReactType = ReliefmonthGridFormDomReact;
        public IsAcsRelative: boolean = false;
        public LeftNum: number = 0;
        public RowList: gridRowFile.ReliefmonthGridRowDom.ReliefmonthGridRowDomVm[];
        public AllCheck: singleCheckFile.ui.SingleCheckBoxVm;
        public FormData: any;
        public CheckBoxList = new Array<singleCheckFile.ui.SingleCheckBoxVm>();
        public ColList: string[] = [];

        public constructor(config?: IReliefmonthGridFormDomConfig) {
            super();
            this.FormData = {};
            this.RowList = new Array<gridRowFile.ReliefmonthGridRowDom.ReliefmonthGridRowDomVm>();
    ...
    export class ReliefmonthGridFormDomStates extends domCore.DomStates {
    }


    export class ReliefmonthGridFormDomProps extends domCore.DomProps<ReliefmonthGridFormDomVm>{
    }
