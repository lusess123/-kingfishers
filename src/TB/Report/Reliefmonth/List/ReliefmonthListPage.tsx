...
import searchFormFile = require("./ReliefmonthSearchFormDom");
import gridFormFile = require("./ReliefmonthGridFormDom");
...
export module ReliefmonthListPage {
    export class ReliefmonthListPageAction extends basewedPageFile.Web.BaseWebPageStates {
        public DataValue: string;
        public Id: string;
        public Vm: any;
    }

    export class ReliefmonthListPageReact extends basewedPageFile.Web.BaseWebPageReact<ReliefmonthListPageProps, ReliefmonthListPageStates, ReliefmonthListPageAction> implements domCore.IReact {

        public state = new ReliefmonthListPageStates();
    ...
    export interface IReliefmonthListPageConfig {
        //PagerListData: dataFile.Reliefmonth.IReliefmonthPagerListData;
        DataSet?: any;
    }

    export class ReliefmonthListPageVm extends basewedPageFile.Web.BaseWebPageVm {
        public ReactType = ReliefmonthListPageReact;
        public SearchFormVm: searchFormFile.ReliefmonthSearchFormDom.ReliefmonthSearchFormDomVm;
        public GridFormVm: gridFormFile.ReliefmonthGridFormDom.ReliefmonthGridFormDomVm;
        ...
        public constructor(config?: IReliefmonthListPageConfig) {
            super();
        ...
        private init(config: IReliefmonthListPageConfig) {
        ...
        protected loadPage(callback?: () => any) {
            urlFile.Core.AkPost("/HZTongBao/Report/Reliefmonth", {  }, (a) => {
                var pageConfig: IReliefmonthListPageConfig = { DataSet: a};
    ...
    export class ReliefmonthListPageStates extends basewedPageFile.Web.BaseWebPageStates {
    }


    export class ReliefmonthListPageProps extends basewedPageFile.Web.BaseWebPageProps<ReliefmonthListPageVm>{
    }
