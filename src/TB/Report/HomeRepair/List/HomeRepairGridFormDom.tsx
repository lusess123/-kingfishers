...
import gridRowFile = require("./HomeRepairGridRowDom");
import singleCheckFile = require("./../../../../02col/02Mulite/SingleCheckBox");
import dataFile = require("./../Data");

export module HomeRepairGridFormDom {
    export class HomeRepairGridFormDomAction extends domCore.DomAction {
    }

    export class HomeRepairGridFormDomReact extends domCore.DomReact<HomeRepairGridFormDomProps, HomeRepairGridFormDomStates, HomeRepairGridFormDomAction> implements domCore.IReact {

        public state = new HomeRepairGridFormDomStates();
    ...
    export interface IHomeRepairGridFormDomConfig {
        DataSet?: any
        UniId: string;
    }

    export class HomeRepairGridFormDomVm extends domCore.DomVm {
        public ReactType = HomeRepairGridFormDomReact;
        public IsAcsRelative: boolean = false;
        public LeftNum: number = 0;
        public RowList: gridRowFile.HomeRepairGridRowDom.HomeRepairGridRowDomVm[];
        public AllCheck: singleCheckFile.ui.SingleCheckBoxVm;
        public FormData: any;
        public CheckBoxList = new Array<singleCheckFile.ui.SingleCheckBoxVm>();
        public ColList: string[] = [];

        public constructor(config?: IHomeRepairGridFormDomConfig) {
            super();
            this.FormData = {};
            this.RowList = new Array<gridRowFile.HomeRepairGridRowDom.HomeRepairGridRowDomVm>();
    ...
    export class HomeRepairGridFormDomStates extends domCore.DomStates {
    }


    export class HomeRepairGridFormDomProps extends domCore.DomProps<HomeRepairGridFormDomVm>{
    }
