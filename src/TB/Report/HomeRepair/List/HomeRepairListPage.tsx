...
import searchFormFile = require("./HomeRepairSearchFormDom");
import gridFormFile = require("./HomeRepairGridFormDom");
...
export module HomeRepairListPage {
    export class HomeRepairListPageAction extends basewedPageFile.Web.BaseWebPageStates {
        public DataValue: string;
        public Id: string;
        public Vm: any;
    }

    export class HomeRepairListPageReact extends basewedPageFile.Web.BaseWebPageReact<HomeRepairListPageProps, HomeRepairListPageStates, HomeRepairListPageAction> implements domCore.IReact {

        public state = new HomeRepairListPageStates();
    ...
    export interface IHomeRepairListPageConfig {
        //PagerListData: dataFile.HomeRepair.IHomeRepairPagerListData;
        DataSet?: any;
    }

    export class HomeRepairListPageVm extends basewedPageFile.Web.BaseWebPageVm {
        public ReactType = HomeRepairListPageReact;
        public SearchFormVm: searchFormFile.HomeRepairSearchFormDom.HomeRepairSearchFormDomVm;
        public GridFormVm: gridFormFile.HomeRepairGridFormDom.HomeRepairGridFormDomVm;
        ...
        public constructor(config?: IHomeRepairListPageConfig) {
            super();
        ...
        private init(config: IHomeRepairListPageConfig) {
        ...
        protected loadPage(callback?: () => any) {
            urlFile.Core.AkPost("/HZTongBao/Report/HomeRepair", {  }, (a) => {
                var pageConfig: IHomeRepairListPageConfig = { DataSet: a};
    ...
    export class HomeRepairListPageStates extends basewedPageFile.Web.BaseWebPageStates {
    }


    export class HomeRepairListPageProps extends basewedPageFile.Web.BaseWebPageProps<HomeRepairListPageVm>{
    }
