...
import searchFormFile = require("./ReportDeptMaintanceSearchFormDom");
import gridFormFile = require("./ReportDeptMaintanceGridFormDom");
...
export module ReportDeptMaintanceListPage {
    export class ReportDeptMaintanceListPageAction extends basewedPageFile.Web.BaseWebPageStates {
        public DataValue: string;
        public Id: string;
        public Vm: any;
    }

    export class ReportDeptMaintanceListPageReact extends basewedPageFile.Web.BaseWebPageReact<ReportDeptMaintanceListPageProps, ReportDeptMaintanceListPageStates, ReportDeptMaintanceListPageAction> implements domCore.IReact {

        public state = new ReportDeptMaintanceListPageStates();
    ...
    export interface IReportDeptMaintanceListPageConfig {
        //PagerListData: dataFile.ReportDeptMaintance.IReportDeptMaintancePagerListData;
        DataSet?: any;
    }

    export class ReportDeptMaintanceListPageVm extends basewedPageFile.Web.BaseWebPageVm {
        public ReactType = ReportDeptMaintanceListPageReact;
        public SearchFormVm: searchFormFile.ReportDeptMaintanceSearchFormDom.ReportDeptMaintanceSearchFormDomVm;
        public GridFormVm: gridFormFile.ReportDeptMaintanceGridFormDom.ReportDeptMaintanceGridFormDomVm;
        ...
        public constructor(config?: IReportDeptMaintanceListPageConfig) {
            super();
        ...
        private init(config: IReportDeptMaintanceListPageConfig) {
        ...
        protected loadPage(callback?: () => any) {
            urlFile.Core.AkPost("/HZTongBao/Report/DeptMaintance", {  }, (a) => {
                var pageConfig: IReportDeptMaintanceListPageConfig = { DataSet: a};
    ...
    export class ReportDeptMaintanceListPageStates extends basewedPageFile.Web.BaseWebPageStates {
    }


    export class ReportDeptMaintanceListPageProps extends basewedPageFile.Web.BaseWebPageProps<ReportDeptMaintanceListPageVm>{
    }
