...
import searchFormFile = require("./ReportElectricalFaultCategorySearchFormDom");
import gridFormFile = require("./ReportElectricalFaultCategoryGridFormDom");
...
export module ReportElectricalFaultCategoryListPage {
    export class ReportElectricalFaultCategoryListPageAction extends basewedPageFile.Web.BaseWebPageStates {
        public DataValue: string;
        public Id: string;
        public Vm: any;
    }

    export class ReportElectricalFaultCategoryListPageReact extends basewedPageFile.Web.BaseWebPageReact<ReportElectricalFaultCategoryListPageProps, ReportElectricalFaultCategoryListPageStates, ReportElectricalFaultCategoryListPageAction> implements domCore.IReact {

        public state = new ReportElectricalFaultCategoryListPageStates();
    ...
    export interface IReportElectricalFaultCategoryListPageConfig {
        //PagerListData: dataFile.ReportElectricalFaultCategory.IReportElectricalFaultCategoryPagerListData;
        DataSet?: any;
    }

    export class ReportElectricalFaultCategoryListPageVm extends basewedPageFile.Web.BaseWebPageVm {
        public ReactType = ReportElectricalFaultCategoryListPageReact;
        public SearchFormVm: searchFormFile.ReportElectricalFaultCategorySearchFormDom.ReportElectricalFaultCategorySearchFormDomVm;
        public GridFormVm: gridFormFile.ReportElectricalFaultCategoryGridFormDom.ReportElectricalFaultCategoryGridFormDomVm;
        ...
        public constructor(config?: IReportElectricalFaultCategoryListPageConfig) {
            super();
        ...
        private init(config: IReportElectricalFaultCategoryListPageConfig) {
        ...
        protected loadPage(callback?: () => any) {
            urlFile.Core.AkPost("/HZTongBao/Report/ElectricalFaultCategory", {  }, (a) => {
                var pageConfig: IReportElectricalFaultCategoryListPageConfig = { DataSet: a};
    ...
    export class ReportElectricalFaultCategoryListPageStates extends basewedPageFile.Web.BaseWebPageStates {
    }


    export class ReportElectricalFaultCategoryListPageProps extends basewedPageFile.Web.BaseWebPageProps<ReportElectricalFaultCategoryListPageVm>{
    }
